...
PGK_short <- function(MSEobj = NULL, Ref = 1, Yrs = c(1, 3)) {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
        "PKG_short: Probability of being in the Kobe green quadrant (SB>SBMSY & F<FMSY) in Years 1-3 (2025-2027)"
    PMobj@Caption <- "Prob. Kobe Green Quadrant (2025-2027)"
    PMobj@Ref <- Ref
...
PGK_med <- function(MSEobj = NULL, Ref = 1, Yrs = c(4, 10)) {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
        "PKG_med: Probability of being in the Kobe green quadrant (SB>SBMSY & F<FMSY) in Years 4-10 (2028-2033)"
    PMobj@Caption <- "Prob. Kobe Green Quadrant (2028-2033)"
    PMobj@Ref <- Ref
    tt <- MSEobj@SB_SBMSY[ , , Yrs[1]:Yrs[2]] > 1 &
        MSEobj@F_FMSY[ , , Yrs[1]:Yrs[2]] < 1
    if (is.null(dim(tt)))
...
PGK_long <- function(MSEobj = NULL, Ref = 1, Yrs = c(11, 30)) {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
        "PKG_long: Probability of being in the Kobe green quadrant (SB>SBMSY & F<FMSY) in Years 11-30 (2034-2054)"
    PMobj@Caption <- "Prob. Kobe Green Quadrant (2034-2054)"
    PMobj@Ref <- Ref
    tt <- MSEobj@SB_SBMSY[ , , Yrs[1]:Yrs[2]] > 1 &
        MSEobj@F_FMSY[ , , Yrs[1]:Yrs[2]] < 1
    if (is.null(dim(tt)))
...
PGK <- function(MSEobj = NULL, Ref = 1, Yrs = c(1, 30)) {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
        "PKG: Probability of being in the Kobe green quadrant (SB>SBMSY & F<FMSY) in Years 1-30 (2025-2054)"
    PMobj@Caption <- "Prob. Kobe Green Quadrant (2025-2054)"
    PMobj@Ref <- Ref
    tt <- MSEobj@SB_SBMSY[ , , Yrs[1]:Yrs[2]] > 1 &
        MSEobj@F_FMSY[ , , Yrs[1]:Yrs[2]] < 1
    if (is.null(dim(tt)))
...
POF <- function(MSEobj = NULL, Ref = 1, Yrs = c(1, 30))  {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
    "POF: Probability of Overfishing (F>FMSY) over all years (2025-2054)"
    PMobj@Caption <- "Prob. Overfishing (F>FMSY) (2025-2054)"
    PMobj@Ref <- Ref
...
PNOF <- function(MSEobj = NULL, Ref = 1, Yrs = c(1, 30))  {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
        "PNOF: Probability of Not Overfishing (F>FMSY) over all years (2025-2054)"
    PMobj@Caption <- "Prob. Not Overfishing (F>FMSY) (2025-2054)"
    PMobj@Ref <- Ref
    PMobj@Stat <- MSEobj@F_FMSY[ , , Yrs[1]:Yrs[2]] < 1
...
LRP_short <- function(MSEobj = NULL, Ref = 0.4, Yrs = c(1, 3)) {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
        "LRP_short: Probability of breaching the limit reference point (SSB<0.4SSB_MSY) in any of the first 3 years (2025-2027)"
    PMobj@Caption <- "Prob. SB < 0.4SBMSY (2025-2027)"
    PMobj@Ref <- Ref
...
LRP_med <- function(MSEobj = NULL, Ref = 0.4, Yrs = c(4, 10)) {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
        "LRP_med: Probability of breaching the limit reference point (SSB<0.4SSB_MSY) in any of years 4-10 (2028-2033)"
    PMobj@Caption <- "Prob. SB < 0.4SBMSY (2028-2033)"
    PMobj@Ref <- Ref
    PMobj@Stat <- MSEobj@SB_SBMSY[, , Yrs[1]:Yrs[2]]
    PMobj@Prob <- calcProb(PMobj@Stat < PMobj@Ref, MSEobj)
    Prob  <- array(as.logical(PMobj@Prob), dim=dim(PMobj@Prob))
...
LRP_long <- function(MSEobj = NULL, Ref = 0.4, Yrs = c(11, 30)) {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
        "LRP_long: Probability of breaching the limit reference point (SSB<0.4SSB_MSY) in any of years 11-30 (2034-2054)"
    PMobj@Caption <- "Prob. SB < 0.4SBMSY (2034-2054)"
    PMobj@Ref <- Ref
    PMobj@Stat <- MSEobj@SB_SBMSY[, , Yrs[1]:Yrs[2]]
    PMobj@Prob <- calcProb(PMobj@Stat < PMobj@Ref, MSEobj)
    Prob  <- array(as.logical(PMobj@Prob), dim=dim(PMobj@Prob))
...
LRP <- function(MSEobj = NULL, Ref = 0.4, Yrs = c(1, 30))  {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
        "LRP: Probability of breaching the limit reference point (SSB<0.4SSB_MSY) over all years (2025-2054)"
    PMobj@Caption <- "Prob. SB < 0.4SBMSY (2025-2054)"
    PMobj@Ref <- Ref
    PMobj@Stat <- MSEobj@SB_SBMSY[, , Yrs[1]:Yrs[2]]
    PMobj@Prob <- calcProb(PMobj@Stat < PMobj@Ref, MSEobj)
    Prob  <- array(as.logical(PMobj@Prob), dim=dim(PMobj@Prob))
...
nLRP_short <- function(MSEobj = NULL, Ref = 0.4, Yrs = c(1, 3)) {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
        "nLRP_short: Probability of not breaching the limit reference point (SSB<0.4SSB_MSY) in any of the first 3 years (2025-2027)"
    PMobj@Caption <- "Prob. of not breaching LRP (2025-2027)"
    PMobj@Ref <- Ref
    PMobj@Stat <- MSEobj@SB_SBMSY[, , Yrs[1]:Yrs[2]]
    PMobj@Prob <- calcProb(PMobj@Stat > PMobj@Ref, MSEobj)
    Prob  <- array(as.logical(PMobj@Prob), dim=dim(PMobj@Prob))
...
nLRP_med <- function(MSEobj = NULL, Ref = 0.4, Yrs = c(4, 10)) {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
        "nLRP_med: Probability of not breaching the limit reference point (SSB<0.4SSB_MSY) in any of years 4-10 (2028-2033)"
    PMobj@Caption <- "Prob. of not breaching LRP (2028-2033)"
    PMobj@Ref <- Ref
    PMobj@Stat <- MSEobj@SB_SBMSY[, , Yrs[1]:Yrs[2]]
    PMobj@Prob <- calcProb(PMobj@Stat > PMobj@Ref, MSEobj)
    Prob  <- array(as.logical(PMobj@Prob), dim=dim(PMobj@Prob))
...
nLRP_long <- function(MSEobj = NULL, Ref = 0.4, Yrs = c(11, 30)) {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
        "nLRP_long: Probability of not breaching the limit reference point (SSB<0.4SSB_MSY) in any of years 11-30 (2034-2054)"
    PMobj@Caption <- "Prob. of not breaching LRP (2034-2054)"
    PMobj@Ref <- Ref
    PMobj@Stat <- MSEobj@SB_SBMSY[, , Yrs[1]:Yrs[2]]
    PMobj@Prob <- calcProb(PMobj@Stat > PMobj@Ref, MSEobj)
    Prob  <- array(as.logical(PMobj@Prob), dim=dim(PMobj@Prob))
...
nLRP <- function(MSEobj = NULL, Ref = 0.4, Yrs = c(1, 30))  {
    ...
    PMobj <- new("PMobj")
    PMobj@Name <-
        "nLRP: Probability of not breaching the limit reference point (SSB<0.4SSB_MSY) over all years (2025-2054)"
    PMobj@Caption <- "Prob. of not breaching LRP (2025-2054)"
    PMobj@Ref <- Ref
    PMobj@Stat <- MSEobj@SB_SBMSY[, , Yrs[1]:Yrs[2]]
    PMobj@Prob <- calcProb(PMobj@Stat > PMobj@Ref, MSEobj)
    Prob  <- array(as.logical(PMobj@Prob), dim = dim(PMobj@Prob))
...
AvC_short <- function(MSEobj = NULL, Ref = 1, Yrs = 3) {
    ...
    PMobj@Caption <- "Median Catch (t) 2025-2027"
...
AvC_med <- function(MSEobj = NULL, Ref = 1, Yrs = c(4, 10)) {
    ...
    PMobj@Caption <- "Median Catch (t) 2028-2033"
    PMobj@Stat <- MSEobj@Removals[ , , Yrs[1]:Yrs[2]]
    PMobj@Ref <- Ref
    PMobj@Prob <- calcProb(PMobj@Stat, MSEobj)
    PMobj@Mean <- calcMedian(PMobj@Prob)
...
AvC_long <- function(MSEobj = NULL, Ref = 1, Yrs = c(11, 30)) {
    ...
    PMobj@Caption <- "Median Catch (t) 2034-2054"
    PMobj@Stat <- MSEobj@Removals[ , , Yrs[1]:Yrs[2]]
    PMobj@Ref <- Ref
    PMobj@Prob <- calcProb(PMobj@Stat, MSEobj)
    PMobj@Mean <- calcMedian(PMobj@Prob)
...
rAvC_short <- function(MSEobj = NULL, Ref = 1, Yrs = c(1, 3)) {
    ...
    PMobj@Caption <- 'Median relative Catch 2025-2027'
...
rAvC_med <- function(MSEobj = NULL, Ref = 1, Yrs = c(4, 10)) {
    ...
    PMobj@Caption <- 'Median relative Catch 2028-2033'
    Stat_y <- MSEobj@Removals[ , , Yrs[1]:Yrs[2]]
    MSYs <- MSEobj@RefPoint$ByYear$MSY
    nyears <- MSEobj@nyears
    MSYs <- MSYs[, nyears + Yrs[1]:Yrs[2]]
...
rAvC_long <- function(MSEobj = NULL, Ref = 1, Yrs = c(11, 30)) {
    ...
    PMobj@Caption <- 'Median relative Catch 2034-2054'
    Stat_y <- MSEobj@Removals[ , , Yrs[1]:Yrs[2]]
    MSYs <- MSEobj@RefPoint$ByYear$MSY
    nyears <- MSEobj@nyears
    MSYs <- MSYs[, nyears + Yrs[1]:Yrs[2]]
...
VarCmedium <- function(MSEobj = NULL, Ref = 1, Yrs = c(4, 10)) {
    ...
    PMobj@Caption <- "Mean Variation in TAC (%) 2028-2033"
...
VarClong <- function(MSEobj = NULL, Ref = 1, Yrs = c(11, 30)) {
    ...
    PMobj@Caption <- "Mean Variation in TAC (%) 2034-2054"
    TAC <- apply(MSEobj@TAC[ , , Yrs[1]:Yrs[2], drop = FALSE],
                 c(1, 2, 3), sum, na.rm = TRUE)
    ## get management cycle
    interval <- min(apply(TAC, 1, firstChange), na.rm = TRUE)
