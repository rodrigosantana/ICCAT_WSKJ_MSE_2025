...
## #####@> Allowing more flexibility in TAC Variation...
## SP_06 <- SP_01
## formals(SP_06)$doSmoother <- TRUE
## class(SP_06) <- 'MP'

#####@> As defining on the original MP - Final 01...
SP <- SurplusProductionStockStatus
class(SP) <- 'MP'

#####@> Including Smoother - Final 02...
## SP02 <- SurplusProductionStockStatus
## formals(SP02)$doSmoother <- TRUE
## class(SP02) <- 'MP'
